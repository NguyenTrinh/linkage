...
#ifndef __dbusxx__lib_linkage_DBusAdaptorGlue_hh__ADAPTOR_MARSHAL_H
#define __dbusxx__lib_linkage_DBusAdaptorGlue_hh__ADAPTOR_MARSHAL_H
...
public:
    ...
    : ::DBus::InterfaceAdaptor("org.linkage.Torrent")
    {
        ...
        register_method(Torrent, GetPath, _GetPath_stub);
    ...
    ::DBus::IntrospectedInterface* const introspect() const 
    {
        ...
        static ::DBus::IntrospectedArgument GetPath_args[] = 
        {
            { "position", "s", false },
            { 0, 0, 0 }
        };
...
private:
    ...
    ::DBus::Message _GetPath_stub( const ::DBus::CallMessage& call )
    {
        ::DBus::MessageIter ri = call.reader();

        ::DBus::String argout1 = GetPath();
        ::DBus::ReturnMessage reply(call);
        ::DBus::MessageIter wi = reply.writer();
        wi << argout1;
        return reply;
...
#endif//__dbusxx__lib_linkage_DBusAdaptorGlue_hh__ADAPTOR_MARSHAL_H
